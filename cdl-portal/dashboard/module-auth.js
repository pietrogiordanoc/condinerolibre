// Sistema de presencia con ubicación IPAPI
// Cache de ubicación para no llamar IPAPI en cada heartbeat
window.userLocationCache = window.userLocationCache || null;
window.cachedSessionId = window.cachedSessionId || null;
window.deviceFingerprint = window.deviceFingerprint || null;
window.userIpAddress = window.userIpAddress || null;
...
async function fetchLocation(sessionId) {
  ...
  try {
    ...
    window.userIpAddress = data.ip || null; // Guardar IP
